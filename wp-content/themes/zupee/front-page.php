                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container"> 
                            <h1><!--Play Ludo.<br>And Win Upto<br>--> <?php echo $hero['heading']; ?><span class="gif-button-top"><?php echo $hero['subheading']; ?></span></h1>  
                            <p class="p-large"><!--Play against real players for real money in this diceless, skill-based game of Ludo.-->
							<?php echo $hero['subheading1']; ?>
							</p>
            <p class="p-small-desk"><!--Outside Google Playstore App Download-->	<?php echo $hero['subheading2']; ?></p>
    <div class=""><a onclick="Atredirect()" class="btn-solid-lg page-scroll"  href="<?php echo $hero['btn_link']; ?>"><i class="fab fa-android"></i>	<?php echo $hero['download_button']; ?></a></br><span class="gif-button"><?php echo $hero['joining_btn']; ?></span><br><!--<img class="gif-button" src="https://www.ludoninja.com/wp-content/uploads/2021/05/bonus10-ani.gif"/>--><br/></div></div>
                    </div> <!-- end of col -->
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid banner-image" src="<?php echo $hero['banner_img']['url']; ?>" alt="alternative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        <h2>How to Play</h2>
                        <ul align="left"><li>Play online anytime of the day.</li></ul>
                        <ul align="left"><li>Check the ranking and scoring details, and proceed to register.</li></ul>
                        <ul align="left"><li>Start playing! All the tokens will be in the open position initially. You get 10 seconds to move each chance.</li></ul>
                        <ul align="left"><li>Game ends when 24 moves are over. Player with Highest score wins. 2nd, 3rd & 4th positions would be decided on the basis of their scores.</br></br></li></ul>
                        <p class="p-small-desk">Outside Google Playstore App Download</p>                     
                        <a class="btn-solid-lg page-scroll" onclick="Atredirect()" href="https://ludoninja.s3.ap-south-1.amazonaws.com/apk/install-ludo-ninja.apk"><i class="fab fa-android"></i>DOWNLOAD & PLAY</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <p align="center">Experience fair play like never before!</br></br></p>
              </div>
            </div> 
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card left-pane first">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                <h4 class="card-title">Exciting New Format</h4>
                                    ...
                                    <div class="card left-pane">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                <h4 class="card-title">Play 24/7</h4>
                                                <p>Play with verified real players any time of the day
</p>
                                            </div>
                                            <div class="card-icon">
                                    ...
                                    <div class="card-body">
                                            <div class="text-wrapper">
                         <h4 class="card-title">Quickest Ludo</h4>
                                                <p>Win the game in 24 moves and take home cash</p>
...
<div class="basic-5 install-sec" id="screenshot" style="background:#1d1a27;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    <div class="section-title">
	<p class="how-to-install-disclaimer">This game involves an element of financial risk and may be addictive. Please play responsibly and at your own risk. T&C Apply. For 18+ only.</p>
